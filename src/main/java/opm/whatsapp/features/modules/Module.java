package opm.whatsapp.features.modules;
...
import opm.whatsapp.features.modules.client.Manager;
import opm.whatsapp.features.setting.Bind;
...
//        Command.sendSilentMessage("" + ChatFormatting.DARK_RED + ChatFormatting.BOLD + "luftwaffe" + ChatFormatting.GRAY + ChatFormatting.BOLD + ".xyz" +  " " + ChatFormatting.RESET + this.displayName + ChatFormatting.GREEN + "enabled");
    }

    public void onDisable() {
//        Command.sendSilentMessage("" + ChatFormatting.DARK_RED + ChatFormatting.BOLD + "luftwaffe" + ChatFormatting.GRAY + ChatFormatting.BOLD + ".xyz" +  " " + ChatFormatting.RESET + this.displayName + ChatFormatting.RED + "disabled");
    }
    ...
    public void setDisplayName(String name) {
        Module module = WhatsApp.moduleManager.getModuleByDisplayName(name);
        Module originalModule = WhatsApp.moduleManager.getModuleByName(name);

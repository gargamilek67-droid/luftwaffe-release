...
import opm.whatsapp.mixin.mixins.access.IEntityLivingBase;
import opm.whatsapp.mixin.mixins.access.IEntityPlayerSP;
import opm.whatsapp.api.wrapper.IMinecraft;
